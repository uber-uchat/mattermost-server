...
func DelayedAutoResponderStatusChange(ruser *model.User) bool {
	...
	fromDate := ruser.NotifyProps[model.AUTO_RESPONDER_FROM_DATE]
	fromTime := ruser.NotifyProps[model.AUTO_RESPONDER_FROM_TIME]
	toDate := ruser.NotifyProps[model.AUTO_RESPONDER_TO_DATE]
	toTime := ruser.NotifyProps[model.AUTO_RESPONDER_TO_TIME]
